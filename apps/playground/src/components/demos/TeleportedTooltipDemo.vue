...
const propsDescription = [
  { name: 'text', type: 'string', default: 'undefined', desc: 'Текст, который отображается в тултипе.' },
  { name: 'position', type: "'top' | 'bottom' | 'left' | 'right'", default: "'top'", desc: 'Позиция тултипа относительно элемента.' },
  { name: 'delay', type: 'number', default: '200', desc: 'Задержка перед появлением тултипа (в мс).' }
]
</script>
...
<template>
  <div class="component-demo">
    <div class="card">
      <h3>Teleported Tooltip Positions</h3>
      <div class="tooltip-container">
        <TeleportedTooltip text="Tooltip on Top" position="top">
          <button class="demo-btn">Hover Top</button>
        </TeleportedTooltip>

        <TeleportedTooltip text="Tooltip on Bottom" position="bottom">
          <button class="demo-btn">Hover Bottom</button>
        </TeleportedTooltip>

        <TeleportedTooltip text="Tooltip on Left" position="left">
          <button class="demo-btn">Hover Left</button>
        </TeleportedTooltip>

        <TeleportedTooltip text="Tooltip on Right" position="right">
    ...
    <div class="card">
      <h3>Delay</h3>
      <div class="tooltip-container">
        <TeleportedTooltip text="Instant tooltip!" :delay="0">
          <button class="demo-btn">No Delay</button>
        </TeleportedTooltip>

        <TeleportedTooltip text="Slow tooltip..." :delay="1000">
          <button class="demo-btn">1000ms Delay</button>
        </TeleportedTooltip>
      </div>
    </div>
